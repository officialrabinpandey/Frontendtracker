        ...
        <section class="text-gray-600 body-font">
            <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
                <div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
                    ...
                    <p class="leading-relaxed mt-4">Saving a penny makes a million if done enough times.</p>
                </div>
                <div class="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                    <h2 class="text-gray-900 text-lg font-medium title-font mb-5">Savers are rich!</h2>
                    ...
                    <p class="text-xs text-gray-500 mt-3">Don't have an account? Sign up</p>
                </div>
            </div>
        </section>
    )
